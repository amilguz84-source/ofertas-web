...
CATEGORY_KEYWORDS = {
    ...
    "Droguería y limpieza": [
        ...
        "cápsulas de detergente", "capsulas de detergente", "ambientador", "insecticida",
        "guantes de látex", "guantes de latex", "bayeta", "fregona", "cubo de fregar",
    ],
    "Moda": [
        ...
        "sandalias", "reloj de pulsera", "cartera", "monedero", "guantes de vestir",
        "gorro", "gorra", "beanie", "bandana", "pulsera", "collar bisutería", "collar bisuteria",
        "pendientes", "anillo", "chándal", "chandal", "parka", "chaleco",
    ],
    "Deporte y aire libre": [
        ...
        "bicicleta estatica", "mancuernas ajustables", "tabla de surf", "stand up paddle",
        "paddle surf", "sup hinchable", "kayak", "tienda de campaña", "camping",
        "saco de dormir", "raqueta de pádel", "raqueta de padel", "pala de padel",
        "hamaca", "nevera portátil", "nevera portatil", "linterna camping", "hinchable piscina",
        "colchoneta hinchable", "flotador", "escalada", "mochila de senderismo",
        "prismáticos", "prismaticos", "brújula", "brujula",
    ],
    "Juguetes": [
        "juguete", "lego", "muñeca", "muneca", "puzzle", "peluche", "playmobil",
        "coche teledirigido", "figura de acción", "figura de accion", "juego de mesa",
        "playset", "pista de coches", "juego de cartas", "construcción", "construccion",
        "plastilina", "kit manualidades",
    ],
    "Belleza y cuidado personal": [
        ...
        "espejo de maquillaje", "neceser de maquillaje", "base de maquillaje", "labial",
        "pintalabios", "máscara de pestañas", "mascara de pestañas",
    ],
    "Bienestar íntimo": [
        "succionador", "satisfyer", "vibrador", "lubricante íntimo", "lubricante intimo",
        "juguete íntimo", "juguete intimo", "estimulador", "preservativo", "anillo vibrador",
    ],
    "Bebé": [
        ...
        "leche infantil", "esterilizador biberones", "calienta biberones", "parque bebé",
        "parque bebe", "andador bebé", "andador bebe",
    ],
    "Mascotas": [
        "perro", "gato", "pienso", "correa", "arenero", "rascador", "acuario",
        "jaula", "comedero mascota", "transportín", "transportin", "collar antipulgas",
        "cama para perro", "juguete para perro", "arena para gatos", "snack para perro",
        "pecera", "filtro acuario", "arnés para perro", "arnes para perro",
    ],
    "Informática": [
        ...
        "disco nvme", "hub usb-c", "docking station", "alfombrilla ratón", "alfombrilla raton",
        "auriculares con micrófono", "auriculares con microfono",
    ],
    "Coche y moto": [
        ...
        "silla de coche bebe", "aspirador de coche", "organizador maletero", "batería coche",
        "bateria coche", "parasol coche", "cera para coche",
    ],
    "Bricolaje y jardín": [
        ...
        "hidrolimpiadora", "generador eléctrico", "generador electrico", "navaja",
        "navaja multiusos", "multiherramienta", "victorinox", "linterna frontal",
        "linterna led", "pintura", "esmalte pintura", "brocha", "rodillo de pintura",
        "cinta métrica", "cinta metrica", "nivel burbuja", "kit de brocas", "soldador",
        "grapadora industrial", "cesped artificial",
    ],
    "Salud": [
        ...
        "cápsulas", "capsulas", "jarabe", "própolis", "propolis", "vahos", "mascarilla ffp2",
        "pulsioxímetro", "pulsioximetro", "inhalador", "vitamina c", "vitamina d",
        "magnesio", "omega 3", "probióticos", "probioticos", "ácido hialurónico", "acido hialuronico",
    ],
    "Videojuegos": [
        "ps5", "playstation", "xbox", "nintendo switch", "mando", "videojuego",
        "auriculares gaming", "silla gamer", "volante gaming", "tarjeta psn",
        "suscripción xbox game pass", "suscripcion xbox game pass", "juego ps5", "juego ps4",
        "juego switch", "juego xbox", "edición físca", "edicion fisica", "elden ring",
        "call of duty", "fifa", "ea sports fc", "gta", "zelda", "mario kart", "pokemon",
        "resident evil", "spider-man", "god of war", "horizon forbidden west",
        "final fantasy", "minecraft", "fortnite", "hogwarts legacy", "nightreign",
    ],
    "Papelería y oficina": [
        ...
        "grapadora", "carpeta clasificadora", "pizarra blanca", "rotafolios",
    ],
    "Viajes y maletas": [
        "maleta", "trolley", "mochila de viaje", "neceser", "almohada de viaje",
        "candado maleta", "báscula de maleta", "bascula de maleta", "organizador de maleta",
        "adaptador de viaje", "funda para maleta",
    ],
    "Muebles": [
        "cómoda", "comoda", "mueble auxiliar", "mesita de noche", "aparador",
        "perchero de pie", "estante de pared", "mueble zapatero", "silla de comedor",
        "mesa plegable", "banqueta", "taburete", "librería mueble", "libreria mueble",
    ],
    "Cocina y menaje": [
        "utensilios de cocina", "juego de utensilios", "espátula de cocina", "espatula de cocina",
        "cuchara de madera", "crepera", "sandwichera", "parrilla eléctrica", "parrilla electrica",
        "grill eléctrico", "grill electrico", "yogurtera", "heladora", "cortafiambres",
        "vajilla", "cubertería", "cuberteria", "juego de cuchillos", "tabla de cortar",
        "recipiente hermético", "recipiente hermetico", "termo", "botella térmica", "botella termica",
    ],
}
...
def get_with_retries(session: requests.Session, url: str, timeout: int, retries: int = 3):
    """Hace una petición GET reintentando ante fallos de red pasajeros
    (timeouts, cortes de conexión) en vez de rendirse a la primera."""
    last_error = None
    for attempt in range(1, retries + 1):
        try:
            ...
            last_error = e
            if attempt < retries:
                time.sleep(2 * attempt)  # espera un poco más en cada intento
    raise last_error
...
def fetch_index_ids(channel: str, session: requests.Session, max_pages: int, delay: float) -> list[str]:
    ...
    for _ in range(max_pages):
        ...
        if before:
            url += f"?before={before}"
        resp = get_with_retries(session, url, timeout=20)
...
def fetch_post_detail(channel: str, post_id: str, session: requests.Session) -> dict:
    ...
    try:
        resp = get_with_retries(session, url, timeout=15)
...
# Fragmentos de dominio que son acortadores genéricos, no marcas reales — si
# terminamos aquí es que no se pudo resolver la redirección real, así que
# mostramos "Otro" en vez de un nombre inventado como "Amz".
GENERIC_SHORTENER_FRAGMENTS = {"amz", "bit", "tinyurl", "cutt", "shorturl", "t", "s", "go"}
...
def extract_marketplace(link: str | None, session: requests.Session, resolve_links: bool) -> str:
    ...
    base = domain.split(".")[0]
    if not base or base.lower() in GENERIC_SHORTENER_FRAGMENTS:
        # Es un acortador genérico sin resolver (p.ej. la redirección falló
        # o tardó demasiado) — mejor "Otro" que un nombre inventado como "Amz".
        return "Otro"
