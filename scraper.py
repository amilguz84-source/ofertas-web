...
CATEGORY_KEYWORDS = {
    ...
    "Televisores y sonido": [
        ...
        "dolby", "android tv", "google tv", "chromecast", "fire tv",
    ],
    ...
    "Iluminación": [
        ...
        "lampara led", "farolillo", "guirnalda luces",
    ],
    "Hogar": [
    ...
    "Coche y moto": [
        ...
        "radar", "co-driver", "detector de radares", "alerta de radares",
    ],
    "Bricolaje y jardín": [
...
SKIP_TITLE_RE = re.compile(
    r"^(oferta cazada|chollo|flash sale|enlace|link|c[oó]digo|cup[oó]n|"
...
def scrape(
    ...
    ofertas.sort(key=lambda o: o.get("date") or "", reverse=True)  # más recientes primero
    return ofertas
